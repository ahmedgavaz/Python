...
class Lecturer(Person):
    def __init__(self,university,experience, name, family, age, nationality):
...
MyPerson.show()
MyPerson=Lecturer("Technical university of Sofia", "40","Ahmed","GAVAZ",19,"BG")
MyPerson.show()
A=Lecturer("Ahmed", "Gavaz", "19", "Bulgarian!!!","fdf","fsf")
A.show()
