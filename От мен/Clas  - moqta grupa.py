...
list1=['Ahmed Gavaz', 'Aksinia Fidosova', 'Aleksandar Avdzhiev',
       ...
       'Edis Madanski', 'Gergana Atanasova', 'Hrisot Garkov', 'Ines Damyanovska',
       'Ivan Bashtenski', 'Ivan Kamenov', 'Ivan Stefanov', 'Lorensia Davidkova',
       'Marina Dimovska', 'Martin Genchev', 'Melis Ibisheva', 'Mladen Chulev',
       'Plamen Petrov', 'Radoslav Zdravkov', 'Sara Stanoevska', 'Shteryu Atanasov',
       "Simona Mihova", 'Teona Denchevska', 'Tsvetan Vatovski', 'Valenskia Davidkova']            
